...
Gallery Twenty WordPress Theme, Copyright 2019 WordPress.org
Gallery Twenty is distributed under the terms of the GNU GPL.
...
Gallery Twenty is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Gallery Twenty bundles the following third-party resources:
...
Bespoke Icons Created For Gallery Twenty
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- GalleryTwenty_SVG_Icons
- gallery_twenty_the_theme_svg()
- gallery_twenty_get_theme_svg()
- gallery_twenty_nav_menu_social_icons()
