...
if ( $comments ) {
	...
	<div class="comments" id="comments">
		...
		<div class="comments-inner section-inner thin max-percentage">
			...
			wp_list_comments(
				array(
					'walker'      => new GalleryTwenty_Walker_Comment(),
					'avatar_size' => 120,
					'style'       => 'div',
				)
			);
			...
			if ( $comment_pagination ) {
				...
				<nav class="comments-pagination pagination<?php echo $pagination_classes; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static output ?>" aria-label="<?php esc_attr_e( 'Comments', 'gallery-twenty' ); ?>">
