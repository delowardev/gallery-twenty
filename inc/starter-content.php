...
function gallery_twenty_get_starter_content() {
	...
	$starter_content = array(
		...
		'posts'       => array(
			'front' => array(
				'post_type'    => 'page',
				'post_title'   => esc_html__( 'The New UMoMA Opens its Doors', 'gallery-twenty' ),
				...
				'post_content' => join(
					...
					array(
						...
						'<h2 class="has-text-align-center">' . esc_html__( 'The premier destination for modern art in Northern Sweden. Open from 10 AM to 6 PM every day during the summer months.', 'gallery-twenty' ) . '</h2>',
						'<!-- /wp:heading --></div></div>',
						'<!-- /wp:group -->',
						...
						'<!-- /wp:image -->',
						'<!-- wp:heading {"level":3} -->',
						'<h3>' . esc_html__( 'Works and Days', 'gallery-twenty' ) . '</h3>',
						'<!-- /wp:heading -->',
						'<!-- wp:paragraph -->',
						'<p>' . esc_html__( 'August 1 -- December 1', 'gallery-twenty' ) . '</p>',
						'<!-- /wp:paragraph -->',
						'<!-- wp:button {"className":"is-style-outline"} -->',
						'<div class="wp-block-button is-style-outline"><a class="wp-block-button__link" href="https://make.wordpress.org/core/2019/09/27/block-editor-theme-related-updates-in-wordpress-5-3/">' . esc_html__( 'Read More', 'gallery-twenty' ) . '</a></div>',
						'<!-- /wp:button --></div></div>',
						'<!-- /wp:group -->',
						'<!-- wp:group -->',
						'<div class="wp-block-group"><div class="wp-block-group__inner-container">',
						...
						'<!-- /wp:image -->',
						'<!-- wp:heading {"level":3} -->',
						'<h3>' . esc_html__( 'Theatre of Operations', 'gallery-twenty' ) . '</h3>',
						'<!-- /wp:heading -->',
						'<!-- wp:paragraph -->',
						'<p>' . esc_html__( 'October 1 -- December 1', 'gallery-twenty' ) . '</p>',
						'<!-- /wp:paragraph -->',
						'<!-- wp:button {"className":"is-style-outline"} -->',
						'<div class="wp-block-button is-style-outline"><a class="wp-block-button__link" href="https://make.wordpress.org/core/2019/09/27/block-editor-theme-related-updates-in-wordpress-5-3/">' . esc_html__( 'Read More', 'gallery-twenty' ) . '</a></div>',
						'<!-- /wp:button --></div></div>',
						...
						'<!-- /wp:image -->',
						'<!-- wp:heading {"level":3} -->',
						'<h3>' . esc_html__( 'The Life I Deserve', 'gallery-twenty' ) . '</h3>',
						'<!-- /wp:heading -->',
						'<!-- wp:paragraph -->',
						'<p>' . esc_html__( 'August 1 -- December 1', 'gallery-twenty' ) . '</p>',
						'<!-- /wp:paragraph -->',
						...
						'<!-- /wp:image -->',
						'<!-- wp:heading {"level":3} -->',
						'<h3>' . esc_html__( 'From Signac to Matisse', 'gallery-twenty' ) . '</h3>',
						'<!-- /wp:heading -->',
						'<!-- wp:paragraph -->',
						'<p>' . esc_html__( 'October 1 -- December 1', 'gallery-twenty' ) . '</p>',
						'<!-- /wp:paragraph -->',
						...
						'<h2 class="has-accent-color has-text-align-center">' . esc_html__( 'Cyborgs, as the philosopher Donna Haraway established, are not reverent. They do not remember the cosmos.', 'gallery-twenty' ) . '</h2>',
						'<!-- /wp:heading --></div></div>',
						'<!-- /wp:group -->',
