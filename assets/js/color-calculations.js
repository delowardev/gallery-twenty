 ...
 * @return {Object} - this
 */
function _galleryTwentyColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_galleryTwentyColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_galleryTwentyColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_galleryTwentyColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _galleryTwentyColor object.
 *
 * @since 1.0.0
 * @param {string} backgroundColor - The background color.
 * @param {number} accentHue - The hue for our accent color.
 * @return {Object} - this
 */
function galleryTwentyColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _galleryTwentyColor( backgroundColor, accentHue );
